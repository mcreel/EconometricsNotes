...
@inbounds begin
g1_v[1]=(-(T[2]*params[1]*exp(y[17])*get_power_deriv(y[3],params[1]-1,1)));
...
g1_v[7]=1;
g1_v[8]=(-1);
g1_v[9]=(-(get_power_deriv(y[13],(-params[4]),1)));
g1_v[10]=1;
g1_v[11]=1;
g1_v[12]=(-(T[1]*T[6]));
g1_v[13]=(-(exp(y[17])*(1-params[1])*T[3]*get_power_deriv(y[15],(-params[1]),1)));
